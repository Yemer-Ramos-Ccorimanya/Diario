...
require_once 'database.php';
    ...
    if(!empty($_POST['cancelar'])){
        echo" USTED CANCELO LA OPERACION <a href='texto_diario.php'> continuar</a>";
    }
...
if (!empty($_POST['modificar'])&&!empty($_POST['titulo']) &&!empty($_POST['texto']) )
    {
        ...
        if (!$result) echo " ! HUBO UNA FALLA EN LA MODIFICACION !<br><br>";
            ...
            die (" SE MODIFICO CORRECTAEMTE SU NOTA<a href='texto_diario.php'> continuar </a> <br/> ");
        }
    }

elseif(empty($_POST['cancelar'])){ echo"NO A MODIFICADO NADA <a href='texto_diario.php'> elija nuevamente una nota</a>";
}
